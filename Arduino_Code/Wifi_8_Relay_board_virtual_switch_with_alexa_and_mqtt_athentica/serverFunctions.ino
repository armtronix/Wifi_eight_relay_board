...
void webHandleConfig(){
  ...
  s += "<label>Device Fifth Name: </label><input name='fifthname' length=64></br>";
  s += "<label>Device Sixth Name: </label><input name='sixthname' length=64></br>";
  s += "<label>Device Seventh Name: </label><input name='seventhname' length=64></br>";
  s += "<label>Device Eighth Name: </label><input name='eighthname' length=64></br>";
...
void webHandleConfigSave(){
  ...
  String qfifthname;
  qfifthname = server.arg("fifthname");
  qfifthname.replace("%2F","/");
  Serial.println("Got fifthname: " + qfifthname);
  fifthName = (char*) qfifthname.c_str();

  String qsixthname;
  qsixthname = server.arg("sixthname");
  qsixthname.replace("%2F","/");
  Serial.println("Got sixthname: " + qsixthname);
  sixthName = (char*) qsixthname.c_str();

  String qseventhname;
  qseventhname = server.arg("seventhname");
  qseventhname.replace("%2F","/");
  Serial.println("Got seventhname: " + qseventhname);
  seventhName = (char*) qseventhname.c_str();

  String qeighthname;
  qeighthname = server.arg("eighthname");
  qeighthname.replace("%2F","/");
  Serial.println("Got eighthname: " + qeighthname);
  eighthName = (char*) qeighthname.c_str();
