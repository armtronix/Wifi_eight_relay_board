...
void SetDevicePower(power_t rpower, int source)
{
  ...
  if (XdrvCall(FUNC_SET_DEVICE_POWER)) {  // Set power state and stop if serviced
    ...
    //Serial.write(0xA0);A004FF
    //Serial.write(0x04);
    Serial.println("Relays:"+String(rpower,DEC));  //Karthik
    //Serial.println(rpower,DEC);
    //Serial.println(rpower,BIN);
    //Serial.write(0xA1);
    //Serial.write('\n');
    //Serial.flush();
  }
...
//      Settings.flag.device_index_enable = user_append_index;
 ...
 //               IrReceiveUpdateThreshold();              //kiran may25
                break;
#endif
